  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .mx-auto.col-md-5.mb-5
      .titulo-sexto.color-acento-contenido
        p.mb-0 #[b Figura 1.] Esquemas de administración

      figure.mb-4
        img(src='@/assets/curso/temas/figuras/esquemaA.svg', alt="En la siguiente imagen se observa un esquema de administración donde el tema principal es Empresa u organización, que maneja los criterios de personas, tareas, estructura, ambiente y tecnología.")
